...
var build_table= async function (wrapname,reqdata){
    current_event=reqdata.event_name;
    current_event_ID=reqdata.event_id;
    var result = await global.process_sql_call("CALL access_get_abilitated_users('"+current_event_ID+"')",null,1);
