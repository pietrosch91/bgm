...
async function specbody(reqdata){
    ...
    var table=await tbuilder.build_table("event_games",reqdata,"association_get_view_to_events",false,false,false);
    // console.log("Table = "+table);
    htmlbody=htmlbody.replace("<!--EVENT_GAMES-->",table);

    table=await tbuilder.build_table("event_games",reqdata,"association_get_view_foster_from",false,false,false);
    // console.log("Table = "+table);
    htmlbody=htmlbody.replace("<!--FOSTER_FROM_GAMES-->",table);

    table=await tbuilder.build_table("event_games",reqdata,"association_get_view_foster_to",false,false,false);
    // console.log("Table = "+table);
